package com.deutscheboerse.examples.fixml.amqp_1_0.qpid_amqp_1_0_jms;
...
public class ConnectionTest
{
    ...
    public void test060SendBroadcastMessageBackend() throws JMSException, NamingException
    {
        ...
        message.setSubject(propertiesBackend.getProperty("destination.broadcastBinding"));
    ...
    {
        assertTrue(receivedRequest.getJMSReplyTo().getAddress().equals(PrepareProperties.getReplyToAddress()));
    }
    ...
    public void test085SendResponseBackend() throws JMSException, NamingException
    {
        ...
        message.setSubject(propertiesBackend.getProperty("destination.responseQueue"));
