package com.deutscheboerse.test_framework.fixml.amqp_1_0.qpid_jms;
...
public class ConnectionTest
{
    ...
    public void test060SendBroadcastMessageBackend() throws JMSException, NamingException
    {
        ...
        message.setJMSType(propertiesBackend.getProperty("queue.broadcastBinding"));
    ...
    {
        assertTrue(receivedRequest.getJMSReplyTo().toString().equals(PrepareProperties.getReplyToAddress()));
    }
    ...
    public void test085SendResponseBackend() throws JMSException, NamingException
    {
        ...
        message.setJMSType(propertiesBackend.getProperty("queue.responseQueue"));
