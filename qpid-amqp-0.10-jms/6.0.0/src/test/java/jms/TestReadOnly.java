...
public class TestReadOnly {
    ...
    public void testReadOnlyQueue() throws JMSException, NamingException, QmfException {
        ...
        Connection senderConnection = Utils.getAdminConnectionBuilder().connectionOption("sync_publish='all'").build();
        ...
        Connection receiverConnection = Utils.getConnectionBuilder().username(USER1_USERNAME).password(USER1_PASSWORD).connectionOption("sync_ack='true'").build();
