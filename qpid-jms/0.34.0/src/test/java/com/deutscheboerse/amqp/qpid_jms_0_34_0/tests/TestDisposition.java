package com.deutscheboerse.amqp.qpid_jms_0_34_0.tests;

import javax.jms.JMSException;
import javax.naming.NamingException;

import com.deutscheboerse.amqp.qpid_jms_0_34_0.utils.Utils;
...
public class TestDisposition extends Disposition {
    ...
    @Test(groups = { "disableInQpid1.35", "disableInQpid1.36", "disableInQpid1.37", "disableInQpid1.38", "disableInQpid1.39", "disableInQpid1.40", "disableInArtemis" })
    @Override
